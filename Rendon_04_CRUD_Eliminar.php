...
<body>
    ...
    <main>
        ...
        <form action="./Rendon_04_CRUD_Eliminar.php" method="post" style="margin-top: 2rem; margin-left: 1rem;">
            <label for="inputIdEliminar">Id</label>
            <input type="text" name="id_eliminar" id="inputIdEliminar">
        ...
        <table style="position:relative; top: 2rem;">
            <tr>
                <th>ID</th>
                <th>Nombre</th>
                <th>Apellidos</th>
