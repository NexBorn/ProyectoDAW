    ...
    <body>
        ...
        <main>
            <div class="container-form">
                ...
                <form class="form" id="form" method="post" action="./Cantos_04_CRUD_Editar_2.php">
					<!-- Id -->
                    <div class="forms_field"  id="form_id">
                        <label for="name" class="form_label">ID:</label>
                        <div class="form_group_inputs">   
                            <input type="text" class="form_input" id="id_protocolo_covid" name="id_protocolo_covid" placeholder="0">
