...
<div class="container-form">
                ...
                <form class="form" id="form" method="post" action="index.php?c=Cantos&f=editar">
                    <!-- Id -->
                    <div id="form_id">
                        <label for="name" class="form_label"></label>
                        <div>   
                            <input type="hidden" type="text" id="id_protocolo_covid" name="id_protocolo_covid" placeholder="0"  value="<?php echo $proto['id_protocolo_covid']; ?>"/>
                    ...
                    <div class="forms_field"  id="form_name">
                        ...
                        <div class="form_group_inputs">   
                            <input type="text" class="form_input" id="name" name="name" placeholder="James Douglas" value="<?php echo $proto['name']; ?>"/>
                    ...
                    <div class="forms_field"  id="form_sur_name">
                        ...
                        <div class="form_group_inputs">   
                            <input type="text" class="form_input" id="sur_name" name="sur_name" placeholder="Cantos Pinto" value="<?php echo $proto['sur_name']; ?>"/>
                            <i class="form_validation "></i>
                    ...
                    <div class="forms_field" id="form_email">
                        ...
                        <div class="form_group_inputs">
                            <input type="email" class="form_input" id="email" name="email" placeholder="james@james.com" value="<?php echo $proto['email']; ?>"/>
                            <i class="form_validation "></i>
                        </div>
                    ...
                    <div class="forms_field" id="form_number_mask" >
                        ...
                        <div class="form_group_inputs">
                           <input type="number" value="1" min="1" max="9" maxlength="1" name="mask" id="number" class="form_input" oninput="maxlengthNumber(this);" value="<?php echo $proto['mask']; ?>"/> 
                        </div>
                    ...
                    <div class="forms_field" id="form_washing">
                        ...
                        <div class="form_group_inputs">
                            <input type="range" class="form_input" id="form_input" name="range_washs" step="5" min="0" max="25" value="<?php echo $proto['range_washs']; ?>"/>   
                        </div>                        
                    ...
                    <div class="forms_field-terms" id="form_term" >
                        ...
                        <div class="form_group_inputs">
                        <input class="form_checkbox" type="checkbox" name="terms" id="terms" value="<?php echo $prod['terms']; ?>"/>
                        </div>
