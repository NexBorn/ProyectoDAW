...
<html lang="es">
	...
	<main>
		<form class="form" id="form" method="post" action="./Cantos_04_CRUD_Eliminar.php">
			<!-- Id -->
            <div class="forms_field"  id="form_id">
                <label for="name" class="form_label">ID:</label>
                <div class="form_group_inputs">   
                    <input type="text" class="form_input" id="id_protocolo_covid_eliminar" name="id_protocolo_covid_eliminar" placeholder="0">
		...
		<?php
            ...
            if(isset($_POST["id_protocolo_covid_eliminar"])){
                $id_protocolo_covid_eliminar = $_POST["id_protocolo_covid_eliminar"];
                $sql= "DELETE FROM protocolo_covid WHERE id_protocolo_covid = $id_protocolo_covid_eliminar";
